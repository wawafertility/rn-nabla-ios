Pod::Spec.new do |spec|
  ...
  spec.name               = "W-NablaCore"
  spec.version            = "2.0.0"
  spec.summary            = "FORKED: NablaCore iOS SDK"
  ...
  spec.source_files       = ["Sources/NablaCore/**/*.swift"]
  spec.resource_bundles   = {"NablaCoreResources" => "Sources/NablaCore/Resources/**/*"}
